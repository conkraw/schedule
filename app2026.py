...
if st.session_state.page == "Home":
    ...
    if uploaded_files:
        ...
        for file in uploaded_files:
            ...
            if name.endswith(".csv"):
                df_csv = pd.read_csv(file, parse_dates=["start_date"]); df_csv.rename(columns={"start_date": "Start Date"}, inplace=True)
	...
	worksheets = [worksheet2, worksheet3, worksheet4, worksheet5, worksheet6, worksheet7, worksheet8, worksheet9, worksheet10, worksheet11]
	...
	al_df = process_file("AL.xlsx", "AL", replacement_rules.get("AL.xlsx"))
